...
<body>
	...
	if (!empty($_COOKIE['news_title_1']) || !empty($_COOKIE['news_title_2']) || !empty($_COOKIE['news_title_3'])) {
		...
		if (!empty($_COOKIE['news_title_1'])) {
			print '
			<p><a href="index.php?menu=2&action=1">' . $_COOKIE['news_title_1'] . '</a></p>';
		}
		if (!empty($_COOKIE['news_title_2'])) {
			print '
			<p><a href="index.php?menu=2&action=2">' . $_COOKIE['news_title_2'] . '</a></p>';
		}
		if (!empty($_COOKIE['news_title_3'])) {
			print '
			<p><a href="index.php?menu=2&action=3">' . $_COOKIE['news_title_3'] . '</a></p>';
		}
		print '
		</aside>';
	}
