...
<body>
    ...
    <main>
        ...
        $kategorije = ['parisien' => 'PARISIEN', 'vivre' => 'VIVRE MIEUX'];

        foreach ($kategorije as $kat_key => $kat_naziv) {
        ?>
        <section>
            <h2><?php echo $kat_naziv; ?></h2>
            <div class="clanci">
            <?php
            $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='$kat_key' LIMIT 3";
